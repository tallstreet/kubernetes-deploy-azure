...
exports.create_master_cloud_config = function (node_count, conf) {
  ...
  return cloud_config.process_template(input_file, output_file, function(data) {
    ...
    data.write_files.push(cloud_config.generate_private_key(util.join_output_file_path('', 'admin-key.pem'), 'admin'));
    data.write_files.push(cloud_config.generate_public_key(util.join_output_file_path('', 'admin.pem'), 'admin'));
    return data;
  });
};
